...
class CategoryManager(models.Manager):
    ...
    CATEGORY_NAME_COUNT_NAME = {
        ...
        'Умные часы': 'smartwatches__count',
    ...
    def get_categories_for_left_sidebar(self):
        models = get_models_for_count('notebook', 'smartphone', 'smartwatches', 'headphones', 'tv')
...
class Product(models.Model):
    ...
    slug = models.SlugField(unique=True)
    iage = models.ImageField(verbose_name='Изображение')
...
class CartProduct(models.Model):
    ...
    final_price = models.DecimalField(max_digits=9, decimal_places=2, verbose_name='Итоговая стоимость')

    def __str__(self):
        return "Продукт:{}(для корзины)".format(self.content_object)
...
class Cart(models.Model):
    ...
    final_price = models.DecimalField(max_digits=9, default=0, decimal_places=2, verbose_name='Итоговая стоимость')
...
class Customer(models.Model):
    ...
    phone = models.CharField(max_length=20, verbose_name='Номер телеофона', null=True, blank=True)
